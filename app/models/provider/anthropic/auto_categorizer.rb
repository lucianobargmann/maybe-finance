class Provider::Anthropic::AutoCategorizer
  ...
  def auto_categorize
      ...
      tools: [
        {
          ...
          description: "Auto-categorize personal finance transactions",
    ...
    Rails.logger.info("Tokens used to auto-categorize transactions: #{response.dig("usage", "input_tokens").to_i + response.dig("usage", "output_tokens").to_i}")
  ...
  private
    ...
    def extract_categorizations(response)
      ...
      tool_use.dig("input", "categorizations") || []
    end
